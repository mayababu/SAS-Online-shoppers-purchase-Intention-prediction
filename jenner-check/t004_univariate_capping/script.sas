...
/*Handling Outliers - capping Informational_Duration using 5th/95th percentiles*/
proc univariate data=online_shoppers noprint;
...
proc print data=online_shoppers_capped(obs=10);
var informational_duration;
run;
